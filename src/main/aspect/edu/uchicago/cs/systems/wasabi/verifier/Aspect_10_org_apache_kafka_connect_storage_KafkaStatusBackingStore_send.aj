...
public aspect Aspect_10_org_apache_kafka_connect_storage_KafkaStatusBackingStore_send {
    ...
    after() throws org.apache.kafka.common.errors.RetriableException : requestMethod() {
