...
public aspect Aspect_1_org_apache_kafka_clients_admin_internals_FenceProducersHandler_handleError {
    ...
    pointcut requestMethodOnly():
        (execution(* org.apache.kafka.clients.admin.internals.FenceProducersHandler+.buildSingleRequest(..)));

    pointcut requestMethod():
        (cflow(execution(* org.apache.kafka.clients.admin.internals.FenceProducersHandler+.handleError(..))) && execution(* org.apache.kafka.clients.admin.internals.FenceProducersHandler+.buildSingleRequest(..)));
    
    //after() throws org.apache.kafka.common.errors.ClusterAuthorizationException : requestMethod() {
    after() throws org.apache.kafka.common.errors.ClusterAuthorizationException : requestMethodOnly() {
        ...
        if (requestAttempts <= NUM_FAILURES_TO_INJECT) {
            ...
            throw new org.apache.kafka.common.errors.ClusterAuthorizationException("wasabi exception from " + thisJoinPoint);
        } else {
