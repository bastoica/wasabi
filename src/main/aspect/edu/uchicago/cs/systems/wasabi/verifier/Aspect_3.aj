...
public aspect Aspect_3 {
    ...
    pointcut requestMethod():
        (withincode(* org.apache.hadoop.hbase.replication.regionserver.HFileReplicator.doBulkLoad(..)) && call(* org.apache.hadoop.hbase.tool.BulkLoadHFilesTool.loadHFileQueue(..)));
