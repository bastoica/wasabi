...
public aspect Aspect_0_org_apache_kafka_clients_admin_internals_AdminApiDriver_retryLookup {
    ...
    pointcut requestMethodOnly():
        (execution(* org.apache.kafka.clients.admin.internals.AdminApiDriver+.onFailure(..)));

    pointcut requestMethod():
        (cflow(execution(* org.apache.kafka.clients.admin.internals.AdminApiDriver+.retryLookup(..))) && execution(* org.apache.kafka.clients.admin.internals.AdminApiDriver+.onFailure(..)));
    
    //after() throws org.apache.kafka.common.errors.DisconnectException : requestMethod() {
    after() throws org.apache.kafka.common.errors.DisconnectException : requestMethodOnly() {
