...
public aspect Aspect_0 {
    ...
    pointcut requestMethod():
        (cflow(execution(* org.apache.hadoop.hbase.regionserver.wal.DualAsyncFSWAL.createWriterInstance(..))) && call(* org.apache.hadoop.hbase.regionserver.wal.DualAsyncFSWAL.createAsyncWriter(..)));
