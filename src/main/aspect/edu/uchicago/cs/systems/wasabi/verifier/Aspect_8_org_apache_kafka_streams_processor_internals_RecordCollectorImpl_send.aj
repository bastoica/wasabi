...
public aspect Aspect_8_org_apache_kafka_streams_processor_internals_RecordCollectorImpl_send {
    ...
    pointcut requestMethod():
        (cflow(execution(* org.apache.kafka.streams.processor.internals.RecordCollectorImpl.send(..))) && execution(* org.apache.kafka.clients.producer.Producer.partitionsFor(..)));
