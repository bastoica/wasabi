...
public class RetryPolicies {
  ...
  static class FailoverOnNetworkExceptionRetry implements RetryPolicy {
    ...
    public RetryAction shouldRetry(Exception e, int retries,
      ...
      LOG.info("[wasabi] RetryPolicies 660");
      if (failovers >= maxFailovers) {
        return new RetryAction(RetryAction.RetryDecision.FAIL, 0,
            "failovers (" + failovers + ") exceeded maximum allowed ("
            + maxFailovers + ")");
      }
      LOG.info("[wasabi] RetryPolicies 666");
      ...
      LOG.info("[wasabi] RetryPolicies 671");
      if (isSaslFailure(e)) {
          return new RetryAction(RetryAction.RetryDecision.FAIL, 0,
                  "SASL failure");
      }
      LOG.info("[wasabi] RetryPolicies 676");
      if (e instanceof ConnectException ||
        ...
        LOG.info("[wasabi] RetryPolicies 695");
        return new RetryAction(RetryAction.RetryDecision.FAIL, 0,
            "Access denied");
