...
public aspect Interceptor {
  ...
  pointcut checkCoverage():
    ...
    (withincode(* org.apache.hadoop.hive.metastore.HiveMetaStoreClientPreCatalog.open(..)) &&
    call(* org.apache.thrift.transport.TTransport.open(..) throws *Exception*)) ||
    (withincode(* org.apache.iceberg.mr.hive.writer.HiveIcebergWriterBase.close(..)) &&
    call(* close(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.Driver.validateTxnList(..)) &&
    call(* setOutdatedTxn(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.exec.mr.Throttle.checkJobTracker(..)) &&
    call(* openStream(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.exec.repl.ranger.RangerRestClientImpl.checkConnection(..)) &&
    call(* executeCallable(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.exec.repl.ReplDumpWork.externalTableCopyTasks(..)) &&
    call(* executeCallable(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.exec.repl.util.SnapshotUtils.isSnapshotAvailable(..)) &&
    call(* executeCallable(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.exec.repl.util.SnapshotUtils.deleteSnapshotIfExists(..)) &&
    call(* executeCallable(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.exec.repl.util.SnapshotUtils.allowSnapshot(..)) &&
    call(* executeCallable(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.exec.repl.util.SnapshotUtils.createSnapshot(..)) &&
    call(* executeCallable(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.exec.repl.util.SnapshotUtils.renameSnapshot(..)) &&
    call(* executeCallable(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.parse.repl.dump.io.FileOperations.exportFilesAsList(..)) &&
    call(* executeCallable(..) throws *Exception*)) ||
    (withincode(* org.apache.hadoop.hive.ql.reexec.ReExecDriver.compileAndRespond(..)) &&
    call(* compileAndRespond(..) throws *Exception*)) ||
    (withincode(* org.apache.hive.service.cli.session.HiveSessionImplwithUGI.getMetaStoreClient(..)) &&
    call(* get(..) throws *Exception*))) &&
